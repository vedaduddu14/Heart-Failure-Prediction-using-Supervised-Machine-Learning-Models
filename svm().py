...
The code here is the same accross all files except the name of algorithm have been chnaged (ex: logistic regression or KNN, along with variations in SVM
etc). However, the code does the exact same thing in all files.
"""
